...
<!-- ci-status-start -->
- **Tests:** 250+ passing (`pytest -q -m "not slow"`); v1.4.0 baseline
  was 247.
- **Ruff:** `ruff check src tests` and `ruff format --check src tests`
  exit 0.
- **Mypy:** 34 errors in 21 files (v1.3 baseline 32; v1.4 added two
  frontier modules and matched the count downward where free).
...
- Initial commit `741e51a`; v1.1 commit `79249df`; v1.2 commit
  ...
  commit `72b73fc`; v1.4.1 commit on `v1.1-fixes`.
<!-- ci-status-end -->
